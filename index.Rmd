...
<li>`r fontawesome::fa("globe")` [PudimDEV](https://pudim.dev) </li>
</ul>

</div>

## About Me
Hello! I'm Nathanael Rolim, a student of International Relations at the Univerity of São Paulo. In some online
...
One of my core values is the belief that I can use simple tools that already exisit in order to improve and facilitate people's tasks. Many of such approaches involve creating applications inside Google Sheets.

At work, I manly work with data visualization and analysis.
